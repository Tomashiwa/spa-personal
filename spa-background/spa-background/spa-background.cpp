...
int main() {
  QueryParser parser;
  //std::string text = "stmt a; read a; print a; call meMaybe; while a; if a; assign kevinGroupLeader; variable v; constant c; procedure p, q, r, s; Select kevinGroupLeader";
